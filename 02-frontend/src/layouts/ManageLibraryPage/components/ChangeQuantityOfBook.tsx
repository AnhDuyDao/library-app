...
export const ChangeQuantityOfBook = (props: { book: BookModel, deleteBook: any }) => {

   const { authState } = useOktaAuth();
   const [quantity, setQuantity] = useState<number>(0);
   const [remaning, setRemaning] = useState<number>(0);

   useEffect(() => {
      const fetchBookInState = () => {
         props.book.copies ? setQuantity(props.book.copies) : setQuantity(0);
         props.book.copiesAvailable ? setRemaning(props.book.copiesAvailable) : setRemaning(0);
      };
      fetchBookInState();
      ...
      <div className="card mt-3 shadow p-3 mb-3 bg-body rounded">
         <div className="row g-0">
            ...
            <div className="mt-3 col-md-4">
               ...
               <div className="d-flex justify-content-center align-items-center">
                  <p>Books Remaining: <b>{remaning}</b></p>
               </div>
            </div>
